...
<body style="height: 469px; width: 224px">
    <form id="form1" runat="server">
        ...
        <asp:CheckBox ID="OnOrder" runat="server" style="z-index: 1; left: 123px; top: 224px; position: absolute" />
        ...
        <asp:Button ID="BtnOK" runat="server" style="z-index: 1; left: 18px; top: 286px; position: absolute" Text="OK" />
